...
await transport.verify();             // fails fast if creds/host/port are wrong
            ...
            const mailOptions = {
                ...
                html: `<p>Click <a href="${process.env.DOMAIN}/verify/${hashedToken}">here</a> to ${emailType === "VERIFY" ? "verify your email" : "reset your password"}.</p>
    ...
    console.log("MAILTRAPUSER:", process.env.MAILTRAPUSER);
console.log("MAILTRAPUSERPASS:", process.env.MAILTRAPUSERPASS);
